...
echo $teacher->teacher_uploaded_content('all','line_smooth','weekly');
echo $teacher->teacher_activities('all','line_sharp','daily');
echo $teacher->teacher_times_pent('all','line_smooth','daily');
