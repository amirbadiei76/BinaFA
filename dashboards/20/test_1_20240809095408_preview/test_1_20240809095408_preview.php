...
echo $student->student_all_grades('user','pie');
echo $student->student_grades_to_top_grade('user','line_smooth');
...
echo $teacher->teacher_activities('user','line_sharp','weekly');
echo $teacher->teacher_times_pent('all','pie','daily');
echo $teacher->teacher_average_times_pent('user','bar','daily');
echo $teacher->teacher_time_response('user','doughnut','daily');
