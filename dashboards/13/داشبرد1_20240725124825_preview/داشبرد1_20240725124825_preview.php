...
echo $teacher->teacher_activities('admin_all_user_self','bar','weekly');
echo $teacher->teacher_times_pent('admin_all_user_self','bar','weekly');
echo $teacher->teacher_average_times_pent('all','line_smooth','daily');
echo $course->course_student_participants('all');
echo $course->course_student_activity_to_view_percentage('all','pie','weekly');
echo $course->course_student_activity_percentage('all','pie','weekly');
echo $course->course_view_count('all','pie','daily');
echo $course->course_student_view_without_activity_rate('user','line_smooth','weekly');
echo $course->course_student_view_rate('all','bar','weekly');
