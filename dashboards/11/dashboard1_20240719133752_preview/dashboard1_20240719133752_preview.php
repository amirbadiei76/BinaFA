    ...
    <div class="preview_right_main_container">
        <div class="preview_right_content">
            ...
            <div class="preview_right_bottom_content">
                <?php
                    echo $student->student_quiz_time('admin_all_user_self','line_smooth');
echo $student->student_main_info('all');
echo $student->student_all_grades('all','table');
echo $student->student_grades_to_top_grade('all','table');
echo $student->student_grades_to_avg_other('all','table');
echo $student->student_active_students('all','line_sharp');
echo $student->student_login_count('all','pie');
echo $teacher->teacher_uploaded_content('admin_all_user_self','pie','daily');
echo $teacher->teacher_activities('all','bar','weekly');
echo $teacher->teacher_times_pent('admin_all_user_self','pie','daily');
echo $teacher->teacher_average_times_pent('user','line_sharp','daily');
echo $teacher->teacher_time_response('admin_all_user_self','bar','daily');
echo $teacher->teacher_main_info('admin_all_user_self');
echo $course->course_student_avg_attempts_to_pass('all','pie','weekly');
echo $course->course_student_passed_percentage_first_attempt('all','pie','weekly');
echo $course->course_student_participants('all');
echo $course->course_student_activity_to_view_percentage('all','pie','daily');
echo $course->course_student_activity_percentage('admin_all_user_self','pie','daily');
echo $course->course_view_count('admin_all_user_self','line_smooth','daily');
echo $course->course_student_view_without_activity_rate('admin_all_user_self','doughnut','daily');
echo $course->course_student_view_rate('all','table',null);
