    ...
    <div class="preview_right_main_container">
        <div class="preview_right_content">
            ...
            <div class="preview_right_bottom_content">
                <?php
                    echo $student->student_active_students('admin_all_user_self','line_sharp');
echo $teacher->teacher_uploaded_content('admin_all_user_self','line_smooth','weekly');
echo $teacher->teacher_time_response('all','table',null);
echo $teacher->teacher_main_info('user');
echo $course->course_student_avg_attempts_to_pass('user','bar','weekly');
